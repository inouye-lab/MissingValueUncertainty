...
if [ $# -ge 3 ]; then
  calibration="--calibration_map ./results/calibration/robust/cifar10/$3.csv" # CSV file for dictionary thing
  zero_var=""
fi
shift $#
...
python mvce_dataset.py cifar10 --output ./results/mvce/robust/cifar10/ \
    --dataset '{ "path": "../../datasets/cifar10", "image_size": 224, "sensor_size": 56 }' \
    --classifier "./models/robust/cifar10/cifar10-$model.pklz" \
