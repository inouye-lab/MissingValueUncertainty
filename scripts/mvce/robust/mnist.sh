...
if [ $# -ge 3 ]; then
  calibration="--calibration_map ./results/calibration/robust/mnist/$3.csv" # CSV file for dictionary thing
  zero_var=""
fi
shift $#
...
python mvce_dataset.py mnist --output ./results/mvce/robust/mnist/ \
