...
python learn_neural_network.py celeba --seed 1337 --output ./models/celeba-10-hair/ --wandb_username "sganguli" \
    ...
    '{
      ...
      "targets": ["Bald", "Blond_Hair","Brown_Hair","Gray_Hair", "Black_Hair", "Wearing_Hat"]
    }'
# resnet options:
#  momentum
#  track_running_stats
